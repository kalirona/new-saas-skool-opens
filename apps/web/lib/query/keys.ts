export const queryKeys = {
  ...
  community: {
    ...
    plans: (uuid: string) => ['community', uuid, 'plans'] as const,
    plan: (planUuid: string) => ['plan', planUuid] as const,
    members: (uuid: string) => ['community', uuid, 'members'] as const,
    userMembership: (uuid: string) => ['community', uuid, 'my-membership'] as const,
  },
  discussion: {
  ...
  resources: {
    list: (orgId: number) => ['resources', orgId] as const,
    detail: (uuid: string) => ['resource', uuid] as const,
    tags: (orgId: number) => ['resources', orgId, 'tags'] as const,
  },
  events: {
    list: (orgId: number) => ['events', orgId] as const,
    detail: (uuid: string) => ['event', uuid] as const,
    upcoming: (orgId: number) => ['events', orgId, 'upcoming'] as const,
  },
  certifications: {
  ...
  analytics: {
    ...
    overview: (orgId: number) => ['analytics', orgId, 'overview'] as const,
  },
  courseUsergroups: {
