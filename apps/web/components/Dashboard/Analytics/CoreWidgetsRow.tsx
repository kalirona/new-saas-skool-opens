'use client'
import { Filter, Trophy, Zap, Eye, Users, CheckCircle, BookOpen, Play, Timer, Expand } from 'lucide-react'
...
export default function CoreWidgetsRow({ days = '30' }: { days?: string }) {
  ...
  return (
    <>
      <div className="bg-white nice-shadow rounded-xl overflow-hidden flex flex-col lg:flex-row divide-y lg:divide-x divide-gray-100">
      ...
      <AnalyticsDetailModal
        ...
        icon={<Filter size={20} className="text-indigo-400" />}
      >
        {chartData.length === 0 ? (
