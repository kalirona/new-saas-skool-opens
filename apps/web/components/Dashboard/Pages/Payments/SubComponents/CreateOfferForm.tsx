          ...
          <div className="px-1.5 py-2 flex-col space-y-3">
            ...
            <div className="border rounded-md p-3 space-y-3 bg-gray-50">
              ...
              <p className="text-xs text-gray-500">
                Add individual courses directly, or link to a Payment Users to grant access to a bundle of resources.
              ...
              {/* Payment Users picker */}
              <div>
                <Label className="text-xs">
                  Payment Users <span className="text-gray-400 font-normal">(optional — for bundles/subscriptions)</span>
                </Label>
                <Select
                ...
                >
                  <SelectTrigger className="text-xs">
                    <SelectValue placeholder="Link to a Payment Users…" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  All resources in the selected Payment Users will be accessible to enrolled users.
