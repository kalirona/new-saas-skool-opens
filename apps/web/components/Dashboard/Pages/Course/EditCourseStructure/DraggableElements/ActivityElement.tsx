import { Backpack, Check, Eye, EyeOff, File, FilePenLine, Globe, GripVertical, Loader2, MoreVertical, Package, Pencil, Save, Sparkles, Trash2, Video, FileText } from 'lucide-react'
...
const ActivityTypeIndicator = ({activityType, activitySubType, isMobile} : { activityType: keyof typeof ACTIVITIES, activitySubType?: string, isMobile: boolean}) => {
  ...
  const {displayNameKey, Icon} = isMarkdown
    ? { displayNameKey: 'markdown', Icon: FileText }
    : isEmbed
    ? { displayNameKey: 'embed', Icon: Globe }
