...
/** Users flat event registry (from API) into categories for the UI. */
                ...
                <div key={event.id}>
                  <div className="flex items-center gap-2 py-1.5 rounded px-1">
                    ...
                    >
                      ...
                      {previewEvent === event.id ? <ChevronUp size={12} className="inline ml-1" /> : <ChevronDown size={12} className="inline ml-1" />}
                    </button>
                  </div>
