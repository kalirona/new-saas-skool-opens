...
const BUILTIN_META: Record<string, BuiltinMeta> = {
  ...
  playgrounds: { feature: 'playgrounds', link: '/playgrounds', labelKey: 'common.playgrounds', Icon: Box },
                            ...
                            {isCustom ? (
                              ...
                              <p className="text-xs text-gray-400">
                                ...
                                {!planAllowed && requiredPlan && (
                                  <span className="text-amber-600 inline-flex items-center gap-1 ml-2"><Lock size={12} />{t('dashboard.organization.menu.plan_locked', { plan: requiredPlan })}</span>
                                )}
