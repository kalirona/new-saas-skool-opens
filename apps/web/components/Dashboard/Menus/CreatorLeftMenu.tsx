...
import { LayoutDashboard, BookOpen, Users, Globe, HelpCircle, Settings, LogOut, Check, ChevronDown, MessageCircle, Book, BarChart3, Search, ShoppingBag, Folder, Calendar, PanelLeftOpen } from 'lucide-react'
...
export const MenuLink = ({ href, icon, label, isCollapsed, isExternal, active }: {
  href: string
...
export default CreatorLeftMenu
