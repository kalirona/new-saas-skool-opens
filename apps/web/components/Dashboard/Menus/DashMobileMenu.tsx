'use client'
import { Home, BookOpen, Users, Globe, Settings, LogOut, MessageCircle, BarChart3, Folder, Calendar, List, X, Check, Book, ChevronDown, Search } from 'lucide-react'
          ...
          <>
            ...
            >
              ...
              <div className="py-2 px-2 max-h-[52vh] overflow-y-auto overscroll-contain space-y-px">
                <PanelItem href="/dash" icon={<Home size={14} />} label={t('common.home')} active={isActive('/dash')} onClick={close} />
                ...
                <PanelItem href="/dash/calendar" icon={<Calendar size={14} />} label={t('common.calendar')} active={isActive('/dash/calendar')} onClick={close} />
