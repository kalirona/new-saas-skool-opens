...
const tools = [
  { mode: 'select' as const, icon: MousePointer, label: 'boards.toolbar.select', colorClass: '' },
  { mode: 'pan' as const, icon: Hand, label: 'boards.toolbar.pan', colorClass: '' },
  { mode: 'draw' as const, icon: Pencil, label: 'boards.toolbar.draw', colorClass: 'editor-tool-btn-interactive' },
  { mode: 'card' as const, icon: Square, label: 'boards.toolbar.add_card', colorClass: 'editor-tool-btn-info' },
  { mode: 'frame' as const, icon: Maximize, label: 'boards.toolbar.frame', colorClass: 'editor-tool-btn-info' },
