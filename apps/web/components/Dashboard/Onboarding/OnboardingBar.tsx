...
import { FilePenLine, BookOpen, CheckCircle, ChevronDown, ChevronUp, Rocket, PlusCircle, Monitor, PlayCircle, FileText, Backpack, Globe, Expand, Minimize, RotateCcw, Pencil, Zap, SkipForward, Lock, MoreHorizontal, UserPlus, Palette, Type, Image, Video, Table, Check, GraduationCap, Command } from 'lucide-react'
...
const ACTIVITY_TYPES = [
  { icon: Monitor, color: 'text-blue-400', label: 'Page' },
  ...
  { icon: FileText, color: 'text-rose-400', label: 'Markdown' },
