'use client'
import { Package, Crown, Shield, User, Users, LogOut, ChevronDown, Globe, Check, ShoppingBag } from 'lucide-react'
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className={`cursor-pointer flex items-center space-x-3 rounded-lg p-2 transition-colors ${colors.profileHover}`}>
                  ...
                  <ChevronDown aria-hidden="true" size={16} className={colors.profileMuted} />
                </button>
              </DropdownMenuTrigger>
