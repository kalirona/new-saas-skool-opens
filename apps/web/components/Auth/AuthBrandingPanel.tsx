...
export default function AuthBrandingPanel({ org, welcomeText }: AuthBrandingPanelProps) {
  ...
  const UNSPLASH_UTM = '?utm_source=platform&utm_medium=referral'
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-10">
        {/* Top bar with logo - hidden for enterprise users */}
        {!isEnterprise && (
          <div className="login-topbar">
            <Link prefetch href={BRAND_LINKS.website} target="_blank">
              <img
                src={BRAND_LOGOS.svg}
                alt=""
                width={30}
