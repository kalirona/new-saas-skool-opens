            ...
            <div className="flex-1 overflow-y-auto px-2 py-2">
              ...
              {sessions.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-32 text-center px-4">
                  <MessageCircle size={20} className="text-neutral-300 dark:text-neutral-600 mb-2" />
              ...
              <div ref={messagesContainerRef} className="flex-1 overflow-y-auto px-3 py-3 space-y-3">
                {isLoadingSession && (
                  <div className="flex flex-col items-center justify-center h-full">
                    <Loader size={18} className="animate-spin text-violet-400 mb-2" />
                ...
                {!isStreaming && !isWaiting && followUps.length > 0 && (
                  <div className="flex flex-col gap-1">
                    {followUps.map((s, i) => (
                      ...
                      >
                        <ArrowRight size={12} className="flex-shrink-0 text-neutral-400 group-hover:text-violet-500" />
