    ...
    <div className="flex flex-row items-center justify-start flex-wrap gap-[7px] max-[1200px]:gap-[5px]">
      ...
      <div className="relative inline-block shrink-0">
        ...
        {showCalloutMenu && (
          <div className="editor-menu-dropdown">
            {[
              { type: 'info',    label: 'Info',    icon: <Info      size={14} />, style: 'text-gray-500'   },
              { type: 'warning', label: 'AlertTriangle', icon: <AlertTriangle   size={14} />, style: 'text-yellow-500' },
              { type: 'tip',     label: 'Tip',     icon: <Lightbulb size={14} />, style: 'text-green-500'  },
              { type: 'success', label: 'Success', icon: <CheckCircle size={14} />, style: 'text-teal-500' },
              { type: 'error',   label: 'Error',   icon: <XCircle   size={14} />, style: 'text-red-500'   },
      ...
      <div className="relative inline-block shrink-0">
        ...
        {showCodeMenu && (
          <div className="editor-menu-dropdown">
            ...
            >
              <span className="icon"><Code size={14} /></span>
            ...
            <div
              ...
              className="editor-menu-item"
            >
              <span className="icon"><Braces size={14} /></span>
