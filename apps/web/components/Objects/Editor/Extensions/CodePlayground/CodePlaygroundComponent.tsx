...
const CodePlaygroundComponent: React.FC = (props: any) => {
  ...
  // GraduationCap custom test cases
  ...
  const tabs: { id: RightTab; label: string; icon: React.ReactNode; badge?: React.ReactNode }[] = [
    ...
    { id: 'history' as RightTab, icon: <History size={14} />, label: 'History' },
  ]
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 px-3.5 py-2.5">
                  {r ? (
                    r.passed ? <CheckCircle2 size={14} className="text-emerald-500 flex-shrink-0" /> : <XCircle size={14} className="text-red-500 flex-shrink-0" />
                  ) : (
                    <CircleDot size={14} className="text-neutral-300 flex-shrink-0" />
                  )}
            ...
            {testCases.length > 0 && !isEditable && results && (
              <div className="rounded-lg p-3.5 border border-neutral-100 nice-shadow">
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  <CheckCircle2 size={12} className={allPassed ? 'text-emerald-500' : 'text-amber-500'} />
