...
// ─── ListMusic Player (podcast-player inspired episode list) ───
...
function AudioBlockComponent(props: ExtendedNodeViewProps) {
  ...
  // ListMusic meta for preview mode
  ...
  return (
    <NodeViewWrapper className="block-audio w-full">
      <div className="bg-neutral-50 rounded-xl px-5 py-4 nice-shadow transition-all ease-linear">
        ...
        {/* MousePointer2 UI (no block object yet) */}
        {!blockObject && (
          <div className="space-y-4">
            ...
            <div className="flex gap-1 bg-neutral-100 rounded-lg p-1">
              {([
                ...
                { key: 'podcast' as TabType, icon: List, label: 'ListMusic' },
              ]).map((tab) => (
                <button
                  key={tab.key}
                ...
                >
                  {isLoading ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-neutral-700">Droplet an audio file or click to browse</p>
