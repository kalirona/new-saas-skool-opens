'use client'
import { Info, AlertTriangle, Lightbulb, CheckCircle, XCircle, X } from 'lucide-react'
              ...
              {(Object.entries(CALLOUT_TYPES) as [CalloutType, typeof CALLOUT_TYPES[CalloutType]][]).map(
                ([type, cfg]) => {
                  ...
                  return (
                    ...
                    >
                      <PickerIcon size={14} weight="fill" className={isActive ? cfg.iconColor : 'text-gray-400'} />
                      {cfg.label}
                    </button>
                  )
                }
