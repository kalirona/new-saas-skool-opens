'use client'
import { HelpCircle, Book, Globe, MessageCircle, LayoutGrid, Presentation, Signpost } from 'lucide-react'
          ...
          <>
            {recentSessions.map((s) => (
              isBubbleMode ? (
                ...
                >
                  <MessageCircle size={14} className="shrink-0 text-neutral-400" />
