...
const UpdatesSection = () => {
  ...
  return (
    <div className='bg-white/95 backdrop-blur-md nice-shadow rounded-lg w-full max-w-[700px] overflow-hidden'>
...
const NewUpdateForm = ({ setSelectedView }: any) => {
  ...
  return (
    <div className='bg-white/95 backdrop-blur-md nice-shadow rounded-lg w-full max-w-[700px] overflow-hidden flex flex-col -space-y-2'>
