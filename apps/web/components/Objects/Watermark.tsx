...
function Watermark() {
    ...
    return (
        <div className='fixed bottom-8 right-8 z-50'>
            <Link href={BRAND_LINKS.website} target="_blank" className="flex items-center cursor-pointer bg-white/80 backdrop-blur-lg text-gray-700 rounded-2xl p-2 light-shadow text-xs px-5 font-semibold space-x-2">
                <p>{t('common.made_with')}</p>
                <Image unoptimized src={BRAND_LOGOS.text} alt="" quality={100} width={95} />
            </Link>
        </div>
    )
}
