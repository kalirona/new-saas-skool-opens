import { ALargeSmall, Hash, Percent, ThumbsUp, GraduationCap, Check, Zap, Shield, Eye, RotateCcw, Infinity as InfinityIcon, Backpack } from 'lucide-react'
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex flex-col min-w-0">
                    ...
                    <p className="text-[10px] text-gray-500 leading-snug mt-0.5 flex items-center gap-1">
                      {maxRetries === 0 ? (
                        <>
                          <InfinityIcon size={12} className="text-fuchsia-500" />
