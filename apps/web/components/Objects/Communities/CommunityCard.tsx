...
import { getCommunityMembers } from '@services/communities/membership'
...
function CommunityCard(props: PropsType) {
  ...
  const { data: membersData } = useQuery({
    queryKey: ['community-card-members', props.community.community_uuid],
    queryFn: () => getCommunityMembers(props.community.community_uuid, undefined, accessToken),
    enabled: !!accessToken,
    staleTime: 120_000,
  })
        ...
        <div className="pt-1.5 flex items-center justify-between border-t border-gray-100">
          <div className="flex items-center gap-3 text-gray-500">
            <div className="flex items-center gap-1.5">
              <Users size={12} />
              <span className="text-[10px] font-bold tabular-nums">{memberCount}</span>
            </div>
            <div className="flex items-center gap-1.5">
