...
import { ArrowLeft, Globe, Check, Save, Eye, EyeOff, SlidersHorizontal, ExternalLink, Pencil, Loader, Slash, SeparatorVertical } from 'lucide-react'
...
const EditorLearnHouseLogo = () => {
  ...
  return (
    <div className="bg-black rounded-md w-[25px] h-[25px] flex items-center justify-center overflow-hidden flex-shrink-0">
      ...
      >
        <Image src={BRAND_LOGOS.svg} alt="" width={14} height={14} className="invert" />
      </motion.div>
    </div>
  )
}
    ...
    <div className="activity-editor-page flex flex-col" style={{ paddingTop: 0 }}>
      ...
      >
        ...
        <div className="flex-1 flex items-center gap-1.5 min-w-0 group">
          ...
          {isSavingTitle && (
            <Loader size={12} className="animate-spin text-gray-400 flex-shrink-0" />
          )}
      ...
      >
        ...
        {/* MessageSquare panel — hidden in fullscreen */}
        {!isFullscreen && (
