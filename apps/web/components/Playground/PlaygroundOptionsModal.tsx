...
import { Globe, Lock, Users, Save, X, Plus, Type, ShieldCheck, Image, Upload, Loader } from 'lucide-react'
...
export default function PlaygroundOptionsModal({
  ...
  const tabs: { id: Tab; label: string; icon: React.ReactNode }[] = [
    { id: 'general', label: 'General', icon: <Type size={14} /> },
    { id: 'access', label: 'Access', icon: <ShieldCheck size={14} /> },
    { id: 'thumbnail', label: 'Thumbnail', icon: <Image size={14} /> },
  ]
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100">
                    <th className="text-left px-4 py-2.5 text-xs font-semibold text-gray-500">Users</th>
