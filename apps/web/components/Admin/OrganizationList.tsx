'use client'
import { Building2, Globe, User, ChevronLeft, ChevronRight, BookOpen, Search, ExternalLink, Plus } from 'lucide-react'
              ...
              <tr key={org.id} className="border-b border-white/[0.05] hover:bg-white/[0.03] transition-colors">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-1.5">
                    <BookOpen size={14} className="text-white/20 shrink-0" />
