'use client'
import { ArrowLeft, Building2, BookOpen, Users, BarChart3, CreditCard, Settings, Globe, Eye, EyeOff, Search, ChevronLeft, ChevronRight, User, Check, ExternalLink, Bot, RotateCw, SlidersHorizontal } from 'lucide-react'
              ...
              >
                <td className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <ExternalLink size={14} className="text-white/20 ml-auto shrink-0" />
                  </div>
                </td>
                <td className="px-4 py-3">
                  <span
