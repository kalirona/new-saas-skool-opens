        ...
        <div className="flex flex-col space-y-2 mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            {allCourses.length === 0 && !searchQuery && (
              <div className="col-span-full">
                <EmptyState
                  icon={<BookCopy className="w-8 h-8 text-gray-300" strokeWidth={1.5} />}
                  title={t('courses.no_courses')}
                  description={isUserAdmin ? t('courses.create_courses_placeholder') : t('courses.no_courses_available')}
                  action={
                    isUserAdmin && (
                      <AuthenticatedClientElement
                        action="create"
                  ...
                  className="border-2 border-dashed border-gray-100 rounded-2xl bg-gray-50/30"
                />
              </div>
            )}
          </div>
