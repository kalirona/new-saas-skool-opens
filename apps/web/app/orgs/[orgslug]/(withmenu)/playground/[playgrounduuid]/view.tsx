...
import { Expand, Minimize, Pencil, Sparkle, Calendar, Globe, Lock, Users, Download } from 'lucide-react'
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            ...
            <div className="absolute top-3 right-3 z-10 flex items-center gap-2">
              ...
              >
                {isFullscreen
                    ? <><Minimize size={14} />{t('playgrounds.view.exit_fullscreen')}</>
                  : <><Expand size={14} />{t('playgrounds.view.fullscreen')}</>
                }
              </button>
            </div>
            ...
            {playground.html_content ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center px-6">
                <div className="w-14 h-14 rounded-2xl bg-white nice-shadow flex items-center justify-center mb-4">
                  <Sparkle size={24} className="text-gray-300" />
                </div>
