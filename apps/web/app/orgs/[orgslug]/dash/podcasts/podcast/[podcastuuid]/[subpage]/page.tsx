...
function PodcastOverviewHeader({
  ...
  if (isLoading) {
    return (
      <div className="pl-10 pr-10 text-sm tracking-tight bg-background z-10 nice-shadow relative animate-pulse">
  ...
  return (
    <div className="pl-4 pr-4 sm:pl-10 sm:pr-10 text-sm tracking-tight bg-background z-10 nice-shadow relative">
      <div className="pt-6 pb-4">
        <Breadcrumbs
          items={[
            {
