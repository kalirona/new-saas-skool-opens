        ...
        return (
          <div className="h-screen w-full bg-background flex items-center justify-center p-4">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <Monitor className='mx-auto my-5' size={64} />    
    ...
    return (
        <>
            <div className='flex mx-auto mt-5 items-center space-x-4'>
                ...
                <div><EllipsisVertical className='text-gray-500' size={14} /></div>
...
const GRADING_TYPE_DISPLAY: Record<string, { icon: React.ReactNode; labelKey: string; color: string }> = {
    ALPHABET: { icon: <ALargeSmall size={14} />, labelKey: 'dashboard.assignments.modals.edit.form.grading_types.alphabet', color: BADGE_VIOLET },
    NUMERIC: { icon: <Hash size={14} />, labelKey: 'dashboard.assignments.modals.edit.form.grading_types.numeric', color: BADGE_BLUE },
    PERCENTAGE: { icon: <Percent size={14} />, labelKey: 'dashboard.assignments.modals.edit.form.grading_types.percentage', color: BADGE_EMERALD },
    PASS_FAIL: { icon: <ThumbsUp size={14} />, labelKey: 'dashboard.assignments.modals.edit.form.grading_types.pass_fail', color: BADGE_AMBER },
    GPA_SCALE: { icon: <GraduationCap size={14} />, labelKey: 'dashboard.assignments.modals.edit.form.grading_types.gpa_scale', color: BADGE_ROSE },
};
