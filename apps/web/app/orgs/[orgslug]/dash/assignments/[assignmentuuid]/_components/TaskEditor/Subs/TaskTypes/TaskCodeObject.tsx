...
type CodeTaskContents = {
  ...
  // GraduationCap-facing behavior. All default to the classic behavior so existing
...
function TaskCodeObject({ view, assignmentTaskUUID, user_id }: TaskCodeObjectProps) {
  ...
  // GraduationCap-gating helpers: derived from the student-behavior flags.
      ...
      <div className="flex flex-col space-y-4">
        ...
        {view === 'teacher' && (
          <>
            ...
            {/* GraduationCap behavior options */}
            <div className="flex flex-col space-y-2">
        ...
        {view === 'grading' && (
          <>
            ...
            {/* GraduationCap's Code (read-only) */}
            <div className="flex flex-col space-y-1">
              <label className="text-xs font-semibold text-slate-500">GraduationCap&apos;s Code</label>
              <div className={`rounded-md overflow-hidden ${cmClassName}`}>
                {cmTheme && (
                  <CodeMirror
                    value={code}
