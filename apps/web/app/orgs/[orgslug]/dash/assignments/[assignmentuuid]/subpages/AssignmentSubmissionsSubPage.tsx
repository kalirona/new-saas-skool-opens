...
function AssignmentSubmissionsSubPage({ assignment_uuid }: { assignment_uuid: string }) {
    ...
    const statusFilters: { key: StatusFilter; label: string; count: number; icon: React.ReactNode; activeClass: string }[] = [
        { key: 'ALL', label: t('dashboard.assignments.submissions.filters.all'), count: stats.total, icon: <Users size={14} />, activeClass: 'bg-neutral-600/80 text-white' },
        { key: 'LATE', label: t('dashboard.assignments.submissions.status.late'), count: stats.late, icon: <Clock size={14} />, activeClass: 'bg-rose-600/80 text-white' },
        { key: 'SUBMITTED', label: t('dashboard.assignments.submissions.status.submitted'), count: stats.submitted, icon: <SendHorizonal size={14} />, activeClass: 'bg-amber-600/80 text-white' },
        { key: 'GRADED', label: t('dashboard.assignments.submissions.status.graded'), count: stats.graded, icon: <CheckCircle2 size={14} />, activeClass: 'bg-emerald-600/80 text-white' },
    ];
