...
import { Search, X, Users, Globe, Lock, ChevronLeft, ChevronRight, MoreVertical, Settings2, Eye, Trash2, CheckSquare, Square, Copy, Presentation } from 'lucide-react'
    ...
    <FeatureGate feature="boards" orgslug={orgslug} context="dashboard">
      <div className="h-full w-full bg-background pl-4 pr-4 sm:pl-10 sm:pr-10">
        <div className="mb-6 pt-6">
          <Breadcrumbs items={[
            { label: t('boards.boards'), href: '/dash/boards', icon: <Presentation size={14} /> }
          ]} />
