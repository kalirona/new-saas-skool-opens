...
from src.services.dash_analytics import (
...
# -------------------------------------------------------------------
# GET /dashboard/overview — PostgreSQL-backed dashboard overview
# -------------------------------------------------------------------
@router.get(
    "/dashboard/overview",
    response_model=DashboardAnalyticsResponse,
    summary="Get org dashboard overview",
    description="Returns key metrics for the org dashboard: active members, course completions, discussion activity, resources, and 12-month growth charts. Queries PostgreSQL directly — no Tinybird dependency.",
    responses={
        200: {"description": "Dashboard overview metrics", "model": DashboardAnalyticsResponse},
        401: {"description": "Authentication required"},
        403: {"description": "User is not a member of the organization"},
    },
)
async def get_dashboard_overview(
    ...
    return await get_dashboard_analytics(org_id, db_session)
