...
from src.routers.ai import ai, magicblocks, courseplanning, rag, generation as ai_generation, assistant as ai_assistant, studio as ai_studio, prompts as ai_prompts
...
from src.routers.communities import spaces as spaces_router_module
from src.routers.communities import membership as membership_router_module
from src.routers.communities import plan_assignments as plan_assignments_router_module
from src.routers.resources import resources as resources_router_module
from src.routers.resources import tags as resource_tags_router_module
from src.routers.events import events as events_router_module
from src.routers.notifications import notifications as notifications_router_module
...
v1_router.include_router(
    spaces_router_module.router,
    tags=["spaces"],
    dependencies=[Depends(require_plan_for_community("standard", "Communities"))]
)
v1_router.include_router(
    membership_router_module.router,
    plan_assignments_router_module.router,
    tags=["membership"],
    dependencies=[Depends(require_plan_for_community("standard", "Communities"))]
)
v1_router.include_router(
...
v1_router.include_router(
    resource_tags_router_module.router,
    tags=["resources", "tags"],
    dependencies=[Depends(require_authenticated_user)]
)
v1_router.include_router(
    events_router_module.router,
    tags=["events"],
    dependencies=[Depends(require_authenticated_user)]
)
v1_router.include_router(
...
# Stripe Payments Router (OSS billing integration)
v1_router.include_router(
...
v1_router.include_router(
    paypal_payments_router,
    tags=["payments"],
    dependencies=[Depends(get_non_api_token_user)]
)

# Billing Dashboard & Member Billing Router (TASKS 5, 7)
v1_router.include_router(
