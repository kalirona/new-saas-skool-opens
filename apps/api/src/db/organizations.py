...
class Organization(OrganizationBase, table=True):
    ...
    explore: Optional[bool] = Field(default=False, index=True)
    stripe_connect_account_id: Optional[str] = Field(default=None, index=True)
    stripe_onboarding_completed: bool = False
    paypal_merchant_id: Optional[str] = Field(default=None, index=True)
    paypal_onboarding_completed: bool = False
    creation_date: str = ""
    update_date: str = ""
